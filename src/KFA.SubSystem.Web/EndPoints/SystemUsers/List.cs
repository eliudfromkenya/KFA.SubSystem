...
public class List(IMediator mediator, IEndPointManager endPointManager) : Endpoint<ListParam, SystemUserListResponse>
{
  ...
  public override void Configure()
  {
    ...
    Summary(s =>
    {
      ...
      s.ResponseExamples[200] = new SystemUserListResponse { SystemUsers = [new SystemUserRecord("Contact", "Email Address", DateTime.Now, true, DateTime.Now, "Name Of The User", "Narration", "", "1000", "Username", DateTime.Now, DateTime.Now)] };
    ...
    CancellationToken cancellationToken)
  {
    ...
    var result = Result<List<SystemUserDTO>>.Success(ans.Select(v => (SystemUserDTO)v).ToList());
