...
public class List(IMediator mediator, IEndPointManager endPointManager) : Endpoint<ListParam, StockItemListResponse>
{
  ...
  public override void Configure()
  {
    ...
    Summary(s =>
    {
      ...
      s.ResponseExamples[200] = new StockItemListResponse { StockItems = [new StockItemRecord("Barcode", "0", "1000", "Item Name", "Narration", DateTime.Now, DateTime.Now)] };
    ...
    CancellationToken cancellationToken)
  {
    ...
    var result = Result<List<StockItemDTO>>.Success(ans.Select(v => (StockItemDTO)v).ToList());
