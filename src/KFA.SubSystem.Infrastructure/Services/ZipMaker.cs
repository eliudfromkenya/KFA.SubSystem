...
{
  public static void Create(string zipName, Dictionary<string, string> files, string password = "Ppas654321")
  {
  ...
  public static void Create(string zipName, IEnumerable<string> filenames, string password = "Ppas654321")
  {
    // Perform some simple parameter checking.  More could be done
    // like checking the target file name is ok, disk space, and lots
    // of other things, but for a demo this covers some obvious traps.
  ...
  public static void Create(string zipName, string contentFolder, string password = "Ppas654321")
  {
    Dictionary<string, string> GetSubFiles(string? parentFolder, string? dir)
    {
      if (string.IsNullOrWhiteSpace(parentFolder))
        throw new ArgumentNullException(nameof(parentFolder), "Please provide dir for zip files");

      if (string.IsNullOrWhiteSpace(dir))
        throw new ArgumentNullException(nameof(dir), "Please provide dir for zip files");
