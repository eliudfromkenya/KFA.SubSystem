...
public sealed record class SalesBudgetBatchHeader : BaseModel
{
  public override string? ___tableName___ { get; protected set; } = "tbl_sales_budget_batch_headers";
  ...
  [MaxLength(25, ErrorMessage = "Please batch number must be 25 characters or less")]
  [Column("batch_number")]
  ...
  public ICollection<SalesBudgetDetail>? SalesBudgetDetails { get; set; }
  public override object ToBaseDTO()
  {
    return (SalesBudgetBatchHeaderDTO)this;
  }
}
