...
public sealed record class PurchasesBudgetBatchHeader : BaseModel
{
  public override string? ___tableName___ { get; protected set; } = "tbl_purchases_budget_batch_headers";
  ...
  {
    return (PurchasesBudgetBatchHeaderDTO)this;
  }
}
