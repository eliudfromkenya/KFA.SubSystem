...
public static class Extensions
{
  ...
  public static byte[] CreatePasswordHash(this string? password, out byte[] passwordSalt)
  {
    if (password?.Length < 2)
      throw new InvalidOperationException("Password is required please");

    using var hmac = new global::System.Security.Cryptography.HMACSHA512();
    passwordSalt = hmac.Key;
    return hmac.ComputeHash(global::System.Text.Encoding.UTF8.GetBytes(password!));
  }
