...
To update the database use this command from the Web project folder (replace `KFA.SubSystem` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../KFA.SubSystem.Infrastructure/KFA.SubSystem.Infrastructure.csproj -s KFA.SubSystem.Web.csproj
```
